  ...
  <div class="container">
    ...
    <div v-else>
      <div class="flex flex-col space-y-6">
        <h2 class="text-2xl font-bold">{{ mountainData.title }}</h2>
        <div>
          <img
        ...
        <div class="w-full">
          ...
          <div class="border rounded p-2 w-11/12 md:w-1/3 mx-auto bg-blue-900">
            <p class="flex justify-between">
              <span>Height:</span> <span>{{ mountainData.height }}</span>
            </p>
            <p class="flex justify-between">
              <span>Continent:</span> <span>{{ mountainData.continent }}</span>
            </p>
            <p class="flex justify-between">
              <span>Countries:</span>
        ...
        <nuxt-link to="/mountains">Back</nuxt-link>
      </div>
    </div>
  </div>
</template>
