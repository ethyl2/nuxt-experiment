<template>
  <div class="min-h-screen">
    <header
      class="h-64 bg-cover bg-no-repeat bg-center flex items-center justify-center"
      style="background-image: url(/can-wall/can-wall.jpg)"
    >
      <h1
        class="text-6xl font-bold font-black text-white text-center px-3 py-1 bg-black rounded bg-opacity-75"
      >
        Can Wall!
      </h1>
    </header>
    <main class="mx-4 md:mx-20">
      <p class="py-6 text-base md:text-xl">
        My family and I have an ongoing art installation at our house -- a can
        wall that is gradually getting bigger and bigger. It serves as a divider
        between my workspace and my daughter's workspace, and doubles as a good
        zoom background.
      </p>
      ...
      >
        ...
        <div class="flex flex-col items-center justify-center w-full md:w-1/2">
          ...
          <ul class="list-disc list-inside">
            ...
            <li>
              <a
                href="https://www.amazon.com/dp/B07FCQKZ4F/ref=cm_sw_r_tw_dp_HDKDW3KE04T0XNJQKTAF"
                target="_blank"
                >Spindrift</a
              >
            </li>
            <li>
              <a
                href="https://www.amazon.com/dp/B07TLYD6SF/ref=cm_sw_r_tw_dp_8MCJRW35Y42EFWH11ZQA"
                target="_blank"
                >La Croix</a
              >
            </li>
            <li>
              <a
                href="https://www.amazon.com/dp/B0859LT36D/ref=cm_sw_r_tw_dp_WQYGP04R3FV8RKM3QF7K"
                target="_blank"
                >Variety of Sodas</a
              >
            </li>
          ...
          >
            ...
            <div
              class="bg-center bg-cover bg-no-repeat w-full h-64"
              style="background-image: url(/can-wall/spindrift-cans.jpg)"
            ></div>
            <div
              class="bg-center bg-cover bg-no-repeat w-full h-64"
              style="background-image: url(/can-wall/la-croix-cans.jpg)"
            ></div>
            <div
              class="bg-center bg-cover bg-no-repeat w-full h-64"
              style="background-image: url(/can-wall/soda-cans.jpg)"
            ></div>
          </div>
        </div>
      </div>
