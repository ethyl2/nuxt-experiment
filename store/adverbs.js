export const state = () => ({
  ...
  actions: [
    ...
    'Drop an ice cube down the back of your shirt.',
    'Get a drink of water.',
    'Arrange six things in a row.',
    'Dance with somebody.',
    'Do five jumping jacks.',
    'Tell me what you ate for breakfast/lunch/dinner/snack.',
    'Pretend to brush your teeth.',
    'Walk down an imaginary runway.',
    'Tell me about your day so far.',
    'Sizzle like bacon.',
    'Run/walk around the room.',
    'Do a tap dance.',
    "Smell someone's armpit.",
    'You and you: swing your partner, do a do-si-do, and promenade around the room.',
    'Open and close a door.',
    'Build a tower with objects around you.',
    'Pretend you are Santa Claus.',
    'Pretend you are the Easter Bunny.',
    'Tell a joke.',
    'Give someone a hug.',
    'Count to 20.',
    'Sing the ABC song.',
    ...
    'Create a creative handshake with another person.',
    'Pretend to pick your nose.',
    'Empty your pockets.',
    'Check the weather.',
    'Take out the garbage.',
    'Tell us why you love your mom/dad/significant other/sibling/etc.',
    'Make toast.',
    'Get me a drink of water.',
    "Describe this painting/what's happening outside/the ceiling.",
    ...
    'You, you, you and you: do the wave.',
    'Give so-and-so a backrub.',
    'Give so-and-so a wet willy.',
    'Give so-and-so a present.',
    'Say hi to each person in the room.',
    'Play with this toy.',
    'Tell me about a favorite vacation.',
    'Read us a page or two of a book.',
    'Stretch.',
    'Sing a commercial jingle (like "Give me a break...").',
    'Get everyone to hold hands.',
    'Make a paper airplane.',
    "Analyze someone's outfit.",
    'Tell us something you admire about so-and-so.',
    'Do the Hokey-Pokey.',
  ...
  steps: [
    ...
    'Choose someone to be <em>it</em>.',
    "After explaining the rules, have <em>it</em> leave the room and go somewhere where they can't hear the group.",
    'When <em>it</em> is gone, choose an adverb -- a word that ends in -ly and describes an action, such as <em>mysteriously</em>.',
    'Have <em>it</em> come back into the room.',
    "<em>It</em> will now tell a person or people in the group to do an action, such as 'Phineas, go shake hands with Ferb.'",
    'The people chosen to do the action then do the action in the manner of the adverb. (Of course, only if they are comfortable and okay with the action.) In our example, they would shake hands mysteriously.',
    'After they finish, <em>it</em> gets a chance to guess the adverb.',
    'If <em>it</em> is correct, the person chosen to do the action will be <em>it</em> for the next round.',
    'Otherwise, <em>it</em> picks a new person or people to do another thing in the manner of the adverb.',
  ],
  colors: [
    '#faf089',
    '#68d391',
